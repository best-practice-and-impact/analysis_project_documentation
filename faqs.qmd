...
What matters here is that each assurance role is covered in your workflow and that individuals or groups in those roles understand and accept their responsibilities.    
...
The AQuA Book makes no expectations about the level of seniority or grade of the occupiers of individuals in the named roles. It does not specify whether roles must be held by a person or could be held by a committee or other governance group (such as a senior leadership team). 

The key consideration is that the person or group that undertakes the assurance role has the skills and resources they need to meet the requirements of the role. How the roles are covered in an analysis workflow will vary from project to project, depending on how the work is planned, managed and assured. 

We suggest that if roles are taken by individuals, the SRO and commissioner should usually be at Grade 7 or above. If you are unsure about how to allocate the roles in your team and governance groups, please [email us](mailto:ASAP@ons.gov.uk) with "analysis assurance" in the subject header and we will help you to make the decision. 
:::
...
Black box models are AI systems whose internal workings are not easily understood or explained, even by their developers. These models are often based on complex algorithms like deep learning networks. They can produce highly accurate results, but their decision-making processes are opaque.
...
You can find [more guidance on AI assurance](https://www.gov.uk/government/publications/introduction-to-ai-assurance/introduction-to-ai-assurance).
:::